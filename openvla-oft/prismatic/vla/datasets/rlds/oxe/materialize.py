...
def make_oxe_dataset_kwargs(
    ...
    action_dim = dataset_kwargs.pop("action_dim", None)
    if dataset_kwargs["action_encoding"] is ActionEncoding.EEF_POS:
        ...
        if action_dim is None:
            action_dim = 7
        dataset_kwargs["absolute_action_mask"] = [False] * (action_dim - 1) + [True]
        dataset_kwargs["action_normalization_mask"] = [True] * (action_dim - 1) + [False]
